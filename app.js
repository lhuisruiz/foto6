...
function modal_088() {
    Swal.fire({
        ...
        //CARPETA 1 
        '<a href="https://drive.google.com/drive/folders/11gXMUR5jsme7ic7msQuVC-HADkZz8sRV?usp=share_link" >' +
        '<button class="bt-msj" >Ver Fotos <i class="fa-solid fa-image blu"></i></button></a>' +
        //CARPETA 2 video
        '<a href="https://drive.google.com/drive/folders/1UhEg4X1E5CcX2_myU8nWnSbC2GoiEymu?usp=share_link" >' + 
        '<button class="bt-msj" >Ver Videos<i class="fa-solid fa-video blu"></i></button></a>'+
        //CARPETA 2 otro
        '<a href="https://drive.google.com/drive/folders/1zigUifkBpTTmV83hbSrRxysXSGAxAk8t?usp=share_link" >' + 
...
const enviarFormulario = () => {
    ...
    var win = window.open(`https://wa.me/54${numero}?text=Mis Fotos App Web:%20https://bit.ly/3gDFqXi%0APara que el enlace se active me tienes que ajenar`, '_blank');
...
botonWspp.addEventListener('click', function () {
    location.href = "https://wa.me/?text=https://bit.ly/3gDFqXi"
});
